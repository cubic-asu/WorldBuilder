	...
	class InitializeWorldHandler implements ClickHandler {
		...
		public void onClick(ClickEvent event) {
			if (worldsList.getSelectedIndex() >= 0) {
				...
				String parsedWorldName = worldsList.getItemText(worldsList.getSelectedIndex()).replaceAll(" ", "_");
				Window.open("https://capstoneglassapi.appspot.com/runworld?world_id=" + parsedWorldName,"_blank","");
			}
